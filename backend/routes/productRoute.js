...
const { getAllProduct, createProduct, updateProduct, deleteProduct, getProductDetails, CreateProductReview, getAllProductReviews, deleteReview } = require("../controllers/productController");
